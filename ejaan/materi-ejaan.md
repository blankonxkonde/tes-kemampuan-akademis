...
**Penyusun:** Tim dosen  
**Mata Kuliah:** Bahasa Indonesia - MKWK107  
...
25. Elipsis
26. Tanda petik
27. Tanda petik tunggal
28. Tanda kurung
29. Tanda kurung siku
30. Tanda garis miring
31. Tanda apostrof

# 1. Huruf

Huruf dalam bahasa Indonesia ada 26 huruf.

| Huruf Kapital | Huruf Nonkapital | Nama | Pengucapan |
| :---: | :---: | :--- | :--- |
| A | a | a | a |
| B | b | be | be |
| C | c | ce | ce |
...
Huruf vokal dalam bahasa Indonesia ada 5 huruf.
...
**Contoh pelafalan huruf e:**
* Anak-anak bermain di **teras**. (teras rumah)
* Upacara itu dihadiri pejabat **teras** [têras] Bank Indonesia. (pejabat utama)
* Kami menonton film **seri**.
* Pertandingan itu berakhir **seri** [sêri]. (imbang)
...
Konsonan dalam bahasa Indonesia dilambangkan dalam 21 huruf.
...
Huruf **x** pada posisi awal kata diucapkan [s] dan pada posisi tengah atau akhir diucapkan [ks].
*Contoh:* xenon [senon].
...
13. **Huruf kapital digunakan pada huruf pertama, seperti pada nama tahun, bulan, hari, dan hari besar atau hari raya.**
    ...
    * hari Jumat, hari Lebaran, hari Natal, hari Galungan
    * tarikh Masehi
...
16. **Huruf kapital digunakan sebagai huruf pertama nama geografi.**
    * *Contoh:* Benua Afrika, Asia Tenggara, Pulau Miangas, Jazirah Arab, Dataran Tinggi Dieng, Gunung Semeru, Pergunungan Himalaya, Teluk Persia, Terusan Suez, Jawa Barat, Jakarta, Kabupaten Konawe, Kota Kupang, Kecamatan Rengasdengklok, Bukit Barisan, Danau Toba, Ngarai Sianok, Sungai Mamberamo, Distrik Samofa, Desa Sentul, Kelurahan Rawamangun, Lembah Baliem, Jalan Polonia, Gang Kelinci, Tanjung Harapan, Selat Lombok, Gedung Yudistira, Ruang Poerwadarminta, Lantai II Gedung Tabrani.
...
23. **Huruf kapital digunakan sebagai huruf pertama kata penunjuk hubungan kekerabatan, seperti bapak, ibu, kakak, dan adik serta kata atau ungkapan lain (termasuk unsur bentuk ulang utuh) yang digunakan sebagai sapaan.**
    ...
    * c. Istilah kekerabatan yang diikuti oleh kata kepemilikan ditulis dengan huruf nonkapital.
...
1.  **Kata dasar ditulis secara mandiri.**
    * kantor
    * pergi
    * ramai
    * sangat
...
4.  **Singkatan kata yang terdiri atas dua huruf atau lebih.**
    **4.1 Singkatan yang terdiri atas lebih dari dua huruf yang lazim digunakan dalam dokumen atau surat-menyurat diikuti dengan tanda titik.**
    * dkk. (dan kawan-kawan)
    * dll. (dan lain-lain)
    * dsb. (dan sebagainya)
    * dst. (dan seterusnya)
    ...
    **4.2 Singkatan yang terdiri atas dua huruf yang lazim digunakan dalam dokumen atau surat-menyurat diikuti tanda titik pada setiap huruf.**
    * a.n. (atas nama)
    * d.a. (dengan alamat)
    * u.b. (untuk beliau)
    * u.p. (untuk perhatian)
    ...
    **4.3 Singkatan yang lazim digunakan dalam penulisan alamat dapat ditulis dengan dua huruf atau lebih dan diakhiri tanda titik.**
...
2.  **Akronim bukan nama diri yang berupa gabungan huruf dan suku kata atau gabungan suku kata dari deret kata ditulis dengan huruf nonkapital.**
...
**Catatan:**
Kata ganti yang ditulis serangkai dengan kata yang mendahuluinya, seperti -ku, -mu, dan -nya ditulis dengan tanda hubung (-) jika digabung dengan bentuk singkatan atau kata yang diawali dengan huruf kapital.
* KTP-mu
* SIM-nya
* STNK-ku
...
* Dalam cerita itu **si** Buta dari Gua Hantu berkelana menyusuri Nusantara.
* Kita harus berserah diri kepada **Sang** Pencipta.
* Pura dibangun oleh umat Hindu untuk memuja **Sang** Hyang Widhi Wasa.

**Catatan:**
1.  Huruf awal **sang** ditulis dengan huruf kapital jika sang merupakan unsur nama Tuhan.
2.  Huruf awal **sang** ditulis dengan huruf kapital jika sang merupakan unsur nama sapaan kehormatan (unsur nama diri).
    * Kita harus berserah diri kepada **Sang** Pencipta.
    * Ratu Shima adalah seorang pemimpin yang tegas sehingga ia mendapat gelar **Sang** Ratu Adil.
...
1.  **Tanda titik digunakan pada akhir kalimat yang bukan pertanyaan atau seruan.**
    ...
    * Apabila telah selesai, tugas itu segera dikumpulkan.
...
2.  **Tanda titik digunakan di belakang angka atau huruf dalam suatu bagan, ikhtisar, atau daftar.**
    ...
    **Catatan:**
    * Tanda titik **tidak** digunakan pada angka atau huruf yang sudah bertanda kurung dalam perincian.
        * Bahasa Indonesia berkedudukan sebagai
            * 1) bahasa nasional yang berfungsi sebagai
                * a) lambang kebanggaan nasional,
                * b) lambang identitas nasional, dan
                * c) alat pemersatu bangsa;
            * 2) bahasa negara ....
    * Tanda titik **tidak** digunakan di belakang angka terakhir pada deret nomor dalam perincian (sistem digital) yang lebih dari satu angka.
        * **2. Gambar Tangan**
        * **2.1 Peta**
        * **2.2 Denah**
...
6.  **Tanda titik tidak digunakan untuk memisahkan bilangan ribuan atau kelipatannya yang tidak menunjukkan jumlah.**
    ...
    * Kata *sila* terdapat dalam *Kamus Besar Bahasa Indonesia* halaman 281.
    * Nomor rekening panitia seminar adalah 0015645678.
    * Dia diangkat sebagai PNS dengan NIP 199001152018031001.

7.  **Tanda titik tidak digunakan pada akhir judul dan subjudul.**
    * **Bentuk dan Kedaulatan (Bab I, UUD 1945)**
    * **Gambar 3 Alat Ucap Manusia**
    * **Tabel 5 Sikap Bahasa Generasi Muda**

8.  **Tanda titik tidak digunakan di belakang alamat penerima dan pengirim surat serta tanggal surat.**
    * Yth. Kepala Badan Pengembangan dan Pembinaan Bahasa
        Jalan Daksinapati Barat IV
        Rawamangun
        Jakarta Timur
    * Indramayu, 1 April 2021
...
1.  **Tanda koma digunakan di antara unsur-unsur dalam perincian berupa kata, frasa, atau bilangan.**
    ...
    * Pelamar harus melengkapi berkas lamarannya dengan melampirkan (1) akta kelahiran, (2) ijazah terakhir, dan (3) surat keterangan kesehatan.
    * Satu, dua, ... tiga!
...
9.  **Tanda koma digunakan di antara (a) nama dan alamat, (b) bagian-bagian alamat, (c) tempat dan tanggal, serta (d) nama tempat dan wilayah yang ditulis berurutan.**
    * Sdr. Rahmat Hidayat, Jalan Sumbawa 1/18, Kelurahan Merdeka, Kecamatan Sumurbandung, Bandung 40113.
...
1.  **Tanda elipsis digunakan untuk menunjukkan bahwa dalam suatu kalimat atau kutipan ada bagian yang dihilangkan.**
    ...
    * b. Tanda elipsis pada akhir kalimat diikuti oleh tanda titik (jumlah titik empat).
...
1.  **Tanda petik digunakan untuk mengapit petikan langsung yang berasal dari pembicaraan, naskah, atau bahan tertulis lain.**
    ...
    * "Besok akan dibahas dalam rapat," kata Andalan.
    * Menurut Pasal 31 Undang-Undang Dasar Negara Republik Indonesia Tahun 1945, "Setiap warga negara berhak mendapat pendidikan."
...
2.  **Tanda petik digunakan untuk mengapit judul puisi, judul lagu, judul artikel, judul naskah, judul bab buku, judul pidato/khotbah, atau tema/subtema yang terdapat di dalam kalimat.**
    ...
    * Perhatikan "Bab I" buku itu!
    * Ceramah "Bahasa Indonesia dalam Era Digital" disampaikan oleh Kepala Badan Bahasa.
    * Tema "Bersatu Kita Teguh" diangkat dalam acara tersebut.
...
3.  **Tanda petik digunakan untuk mengapit istilah ilmiah yang kurang dikenal atau kata yang mempunyai arti khusus.**
    ...
    * Semakin "kepo", semakin tinggi rasa ingin tahunya.

---

# 27. Tanda Petik Tunggal ('...')

1.  **Tanda petik tunggal digunakan untuk mengapit petikan yang terdapat di dalam petikan lain.**
...
2.  **Tanda petik tunggal digunakan untuk mengapit makna, padanan, atau penjelasan kata atau ungkapan.**
    ...
    * *tadulako* 'panglima'
    * *marsiadapari* 'gotong royong' (Batak)
    * *tuah sakato* 'sepakat demi manfaat bersama' (Minang)
    * *policy* 'kebijakan'
...
1.  **Tanda kurung digunakan untuk mengapit keterangan tambahan, seperti singkatan atau padanan kata asing.**
    ...
    * Jakarta (ANTARA) - Sebagian besar wilayah Indonesia berpotensi hujan.
    * Proklamator Kemerdekaan Republik Indonesia (Soekarno-Hatta)
...
3.  **Tanda kurung digunakan untuk mengapit huruf atau angka yang digunakan sebagai penanda perincian yang ditulis ke samping atau ke bawah.**
    * Faktor produksi menyangkut (a) alam, (b) tenaga kerja, dan (c) modal.
    * Dia harus melengkapi berkas lamaran dengan melampirkan
        (1) akta kelahiran,
...
1.  **Tanda kurung siku digunakan untuk mengapit huruf, kata, atau kelompok kata sebagai koreksi atau tambahan atas kesalahan atau kekurangan di dalam naskah asli yang ditulis orang lain.**
    ...
    * Ulang tahun [Proklamasi Kemerdekaan] Republik Indonesia dirayakan setiap tahun.
...
1.  **Tanda apostrof dapat digunakan untuk menunjukkan penghilangan bagian kata atau bagian angka tahun dalam konteks tertentu.**
